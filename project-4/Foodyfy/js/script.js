...
const updateCart = () => {
    let cartTextContent = parseInt(cartText.textContent);
    cartTextContent += 1;
    cartText.textContent = cartTextContent;

    console.log("Cart text is", cartTextContent);
}
...
forms.forEach(form => {
    ...
    < div class="fixed transform -translate-x-1/2 top-0 left-1/2" >
